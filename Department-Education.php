...
$sql_tourism = "SELECT * FROM education_research";  // Adjust based on your actual table name and fields
$result_tourism = $conn->query($sql_tourism);
...
<head>
  ...
  <title>Components / Education</title>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Education Research Data</h5>

              <!-- Table with education research data -->
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='5'>No research data found</td></tr>";
                  }
                  ?>
                </tbody>
              </table>
